...
export class DataServiceService {
  ...
  addEmployee(employeeObj): Observable<any> {
    ...
    return this._http.post(this.baseUrl +'/employee/create', employeeObj, options).pipe(
      map((response: any) => {
  ...
  addDept(departmentObj): Observable<any> {
    ...
    headers.append('x-access-token', `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.R7Um3OdOS6601qgn9TylIaxAa9MrAfAr0J4UZD4wSks`);
    const options = new RequestOptions({ headers: headers });
     return this._http.post(this.baseUrl +'/department/create', departmentObj, options).pipe(
       map((response: any) => {
        console.log(response);
        return response;
        },
  ...
  addUser(usersObj) {
    ...
    headers.append('x-access-token', `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.R7Um3OdOS6601qgn9TylIaxAa9MrAfAr0J4UZD4wSks`);
    const options = new RequestOptions({ headers: headers });
    this._http.post(this.baseUrl +'/login/create', usersObj, options)
      .subscribe(
        res => {
          console.log(res);
        },
  ...
  addVisitor(visitorObj): Observable<any> {
    ...
    headers.append('x-access-token', `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.R7Um3OdOS6601qgn9TylIaxAa9MrAfAr0J4UZD4wSks`);
    const options = new RequestOptions({ headers: headers });
    return this._http.post(this.baseUrl +'/visitor/create', visitorObj, options).pipe(
      map((response: any) => {
        console.log(response);
        return response;
        },
  ...
  updateEmployee(employeeObj): Observable<any> {
    ...
    headers.append('x-access-token', `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.R7Um3OdOS6601qgn9TylIaxAa9MrAfAr0J4UZD4wSks`);
    const options = new RequestOptions({ headers: headers });
    return this._http.post(this.baseUrl +'/employee/update', employeeObj, options).pipe(
      map((response: any) => {
        console.log(response);
        return response;
      },
  ...
  updateDepartment(departmentObj): Observable<any> {
    ...
    headers.append('x-access-token', `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.R7Um3OdOS6601qgn9TylIaxAa9MrAfAr0J4UZD4wSks`);
    const options = new RequestOptions({ headers: headers });
    return this._http.post(this.baseUrl +'/department/update', departmentObj, options).pipe(
      map((response: any) => {
        console.log(response);
        return response;
      },
  ...
  updateVisitor(visitorObj): Observable<any> {
    ...
    return this._http.post(this.baseUrl +'/visitor/update', visitorObj, options).pipe(
      map((response: any) => {
        console.log(response);
        return response;
      },
  ...
  deleteEmployee(employeeID) {
    ...
    return this._http.get(this.baseUrl +'/employee/delete/' + employeeID, options).pipe(
      map((response: any) => {
        console.log(response);
        return response;
      },
  ...
  deleteDepartment(departmentID) {
    ...
    return this._http.get(this.baseUrl +'/department/delete/' + departmentID, options).pipe(
      map((response: any) => {
        console.log(response);
        return response;
      },
   ...
   deleteVisitor(srno) {
    ...
    return this._http.get(this.baseUrl +'/visitor/delete/' + srno, options).pipe(
      map((response: any) => {
        console.log(response);
        return response;
      },
  ...
  getEmployee() {
    ...
    const options = new RequestOptions({ headers: headers });
    this.employeeList = [];
    this._http.get(this.baseUrl +'/employee/list', options).subscribe(response => {
      let userdata = [];
  ...
  getDepartment() {
    ...
    const options = new RequestOptions({ headers: headers });
    this.deptList = [];
    this._http.get(this.baseUrl +'/department/list', options).subscribe(response => {
      let deptData = [];
      if (response.json().hits && response.json().hits.hits) {
  ...
  getVisitor() {
    ...
    const options = new RequestOptions({ headers: headers });
    this.visitorList = [];
    this._http.get(this.baseUrl +'/visitor/list', options).subscribe(response => {
      let userdata = [];
      if (response.json().hits && response.json().hits.hits) {
        userdata = response.json().hits.hits;
        if (userdata.length > 0) {
  ...
  getLoginUser(userId): Observable<any> {
    ...
    let userObj;
    return this._http
      .get(this.baseUrl +'/login/' + userId, options).pipe(
        map((response: any) => {
          if (response.json().hits && response.json().hits.hits) {
            userdata = response.json().hits.hits;
            if (userdata.length > 0) {
  ...
  getLookup(type): Observable<any> {
    ...
    let lookupList = [];
    return this._http
      .get(this.baseUrl +'/lookup/list?type=' + type, options).pipe(
        map((response: any) => {
          if (response.json().hits && response.json().hits.hits) {
            userdata = response.json().hits.hits;
            if (userdata.length > 0) {
              userdata.forEach(user => {
                lookupList.push(user._source);
              });
            }
            return lookupList;
          }
